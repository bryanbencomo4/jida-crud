<?php
  ...
  class Router{
    ...
    private function runGet(){
      $urlSlitTemp = explode(".",$this->urlBrowser);
      if(strtolower($urlSlitTemp[(count($urlSlitTemp)-1)])=="jpg" || strtolower($urlSlitTemp[(count($urlSlitTemp)-1)])=="png" || strtolower($urlSlitTemp[(count($urlSlitTemp)-1)])=="gif" ||strtolower($urlSlitTemp[(count($urlSlitTemp)-1)])=="pdf"){
        echo $this->urlBrowser;
        header("location: ".$this->urlBrowser);
        exit();
      }
